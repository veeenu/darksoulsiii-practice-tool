...
// **********************************
use super::*;
use crate::{ParamStruct, ParamVisitor};
...
pub static PARAM_VTABLE: LazyLock<HashMap<String, BoxedVisitorLambda>> = LazyLock::new(|| {
    [
        ...
        ("AtkParam_Npc".to_string(), unsafe {
            get_lambda::<AtkParam_Npc>()
        }),
        ("AtkParam_Pc".to_string(), unsafe {
            get_lambda::<AtkParam_Pc>()
        }),
        ...
        ("LodParam_ps4".to_string(), unsafe {
            get_lambda::<LodParam_ps4>()
        }),
        ("LodParam_xb1".to_string(), unsafe {
            get_lambda::<LodParam_xb1>()
        }),
        ...
        ("MenuValueTableParam".to_string(), unsafe {
            get_lambda::<MenuValueTableParam>()
        }),
        ...
        ("ProtectorGenParam".to_string(), unsafe {
            get_lambda::<ProtectorGenParam>()
        }),
        ("RagdollParam".to_string(), unsafe {
            get_lambda::<RagdollParam>()
        }),
        ...
        ("SkeletonParam".to_string(), unsafe {
            get_lambda::<SkeletonParam>()
        }),
        ("SpEffectParam".to_string(), unsafe {
            get_lambda::<SpEffectParam>()
        }),
        ("SpEffectVfxParam".to_string(), unsafe {
            get_lambda::<SpEffectVfxParam>()
        }),
        ...
        ("UpperArmParam".to_string(), unsafe {
            get_lambda::<UpperArmParam>()
        }),
        ("WeaponGenParam".to_string(), unsafe {
            get_lambda::<WeaponGenParam>()
        }),
