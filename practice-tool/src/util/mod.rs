...
// pub(crate) struct KeyState(u32, Option<i32>);
//
...
//         ui.is_key_index_released(self.0) && self.is_modifier_down(ui)
//     }
//
//     pub(crate) fn keydown(&self, ui: &imgui::Ui) -> bool {
//         ui.is_key_index_pressed(self.0) && self.is_modifier_down(ui)
//     }
//
//     pub(crate) fn is_key_down(&self, ui: &imgui::Ui) -> bool {
//         ui.is_key_index_down(self.0) && self.is_modifier_down(ui)
//     }
// }
//
