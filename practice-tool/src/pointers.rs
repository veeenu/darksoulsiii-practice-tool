...
impl From<BaseAddresses> for PointerChains {
    fn from(b: BaseAddresses) -> Self {
        ...
        PointerChains {
            ...
            all_draw_hit: pointer_chain!(base_z as usize, 0x66),
            ik_foot_ray: pointer_chain!(base_z as usize, 0x6B),
            debug_sphere_1: pointer_chain!(base_hbd as usize, 0x30),
            debug_sphere_2: pointer_chain!(base_hbd as usize, 0x31),
