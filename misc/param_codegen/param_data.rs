...
pub static RENDER_VTABLE: Lazy<HashMap<String, Box<dyn Fn(*const c_void, &imgui::Ui)>>> = Lazy::new(|| {
    [

        ("ActionButtonParam".to_string(), get_render_lambda::<ActionButtonParam>()),
        ("AiSoundParam".to_string(), get_render_lambda::<AiSoundParam>()),
        ("AtkParam_Npc".to_string(), get_render_lambda::<AtkParam_Npc>()),
        ("AtkParam_Pc".to_string(), get_render_lambda::<AtkParam_Pc>()),
        ("AttackElementCorrectParam".to_string(), get_render_lambda::<AttackElementCorrectParam>()),
        ("BehaviorParam".to_string(), get_render_lambda::<BehaviorParam>()),
        ("BehaviorParam_PC".to_string(), get_render_lambda::<BehaviorParam_PC>()),
        ("BonfireWarpParam".to_string(), get_render_lambda::<BonfireWarpParam>()),
        ("BudgetParam".to_string(), get_render_lambda::<BudgetParam>()),
        ("Bullet".to_string(), get_render_lambda::<Bullet>()),
        ("BulletCreateLimitParam".to_string(), get_render_lambda::<BulletCreateLimitParam>()),
        ("CalcCorrectGraph".to_string(), get_render_lambda::<CalcCorrectGraph>()),
        ("Ceremony".to_string(), get_render_lambda::<Ceremony>()),
        ("CharacterLoadParam".to_string(), get_render_lambda::<CharacterLoadParam>()),
        ("CharaInitParam".to_string(), get_render_lambda::<CharaInitParam>()),
        ("CharMakeMenuListItemParam".to_string(), get_render_lambda::<CharMakeMenuListItemParam>()),
        ("CharMakeMenuTopParam".to_string(), get_render_lambda::<CharMakeMenuTopParam>()),
        ("ClearCountCorrectParam".to_string(), get_render_lambda::<ClearCountCorrectParam>()),
        ("CoolTimeParam".to_string(), get_render_lambda::<CoolTimeParam>()),
        ("CultSettingParam".to_string(), get_render_lambda::<CultSettingParam>()),
        ("DecalParam".to_string(), get_render_lambda::<DecalParam>()),
        ("DirectionCameraParam".to_string(), get_render_lambda::<DirectionCameraParam>()),
        ("EquipMtrlSetParam".to_string(), get_render_lambda::<EquipMtrlSetParam>()),
        ("EquipParamAccessory".to_string(), get_render_lambda::<EquipParamAccessory>()),
        ("EquipParamGoods".to_string(), get_render_lambda::<EquipParamGoods>()),
        ("EquipParamProtector".to_string(), get_render_lambda::<EquipParamProtector>()),
        ("EquipParamWeapon".to_string(), get_render_lambda::<EquipParamWeapon>()),
        ("FaceGenParam".to_string(), get_render_lambda::<FaceGenParam>()),
        ("FaceParam".to_string(), get_render_lambda::<FaceParam>()),
        ("FaceRangeParam".to_string(), get_render_lambda::<FaceRangeParam>()),
        ("FootSfxParam".to_string(), get_render_lambda::<FootSfxParam>()),
        ("GameAreaParam".to_string(), get_render_lambda::<GameAreaParam>()),
        ("GameProgressParam".to_string(), get_render_lambda::<GameProgressParam>()),
        ("GemCategoryParam".to_string(), get_render_lambda::<GemCategoryParam>()),
        ("GemDropDopingParam".to_string(), get_render_lambda::<GemDropDopingParam>()),
        ("GemDropModifyParam".to_string(), get_render_lambda::<GemDropModifyParam>()),
        ("GemeffectParam".to_string(), get_render_lambda::<GemeffectParam>()),
        ("GemGenParam".to_string(), get_render_lambda::<GemGenParam>()),
        ("HitEffectSeParam".to_string(), get_render_lambda::<HitEffectSeParam>()),
        ("HitEffectSfxConceptParam".to_string(), get_render_lambda::<HitEffectSfxConceptParam>()),
        ("HitEffectSfxParam".to_string(), get_render_lambda::<HitEffectSfxParam>()),
        ("HitMtrlParam".to_string(), get_render_lambda::<HitMtrlParam>()),
        ("HPEstusFlaskRecoveryParam".to_string(), get_render_lambda::<HPEstusFlaskRecoveryParam>()),
        ("ItemLotParam".to_string(), get_render_lambda::<ItemLotParam>()),
        ("KnockBackParam".to_string(), get_render_lambda::<KnockBackParam>()),
        ("KnowledgeLoadScreenItemParam".to_string(), get_render_lambda::<KnowledgeLoadScreenItemParam>()),
        ("LoadBalancerDrawDistScaleParam".to_string(), get_render_lambda::<LoadBalancerDrawDistScaleParam>()),
        ("LoadBalancerParam".to_string(), get_render_lambda::<LoadBalancerParam>()),
        ("LockCamParam".to_string(), get_render_lambda::<LockCamParam>()),
        ("LodParam".to_string(), get_render_lambda::<LodParam>()),
        ("LodParam_ps4".to_string(), get_render_lambda::<LodParam_ps4>()),
        ("LodParam_xb1".to_string(), get_render_lambda::<LodParam_xb1>()),
        ("Magic".to_string(), get_render_lambda::<Magic>()),
        ("MapMimicryEstablishmentParam".to_string(), get_render_lambda::<MapMimicryEstablishmentParam>()),
        ("MenuOffscrRendParam".to_string(), get_render_lambda::<MenuOffscrRendParam>()),
        ("MenuPropertyLayoutParam".to_string(), get_render_lambda::<MenuPropertyLayoutParam>()),
        ("MenuPropertySpecParam".to_string(), get_render_lambda::<MenuPropertySpecParam>()),
        ("MenuValueTableParam".to_string(), get_render_lambda::<MenuValueTableParam>()),
        ("ModelSfxParam".to_string(), get_render_lambda::<ModelSfxParam>()),
        ("MoveParam".to_string(), get_render_lambda::<MoveParam>()),
        ("MPEstusFlaskRecoveryParam".to_string(), get_render_lambda::<MPEstusFlaskRecoveryParam>()),
        ("MultiHPEstusFlaskBonusParam".to_string(), get_render_lambda::<MultiHPEstusFlaskBonusParam>()),
        ("MultiMPEstusFlaskBonusParam".to_string(), get_render_lambda::<MultiMPEstusFlaskBonusParam>()),
        ("MultiPlayCorrectionParam".to_string(), get_render_lambda::<MultiPlayCorrectionParam>()),
        ("MultiSoulBonusRateParam".to_string(), get_render_lambda::<MultiSoulBonusRateParam>()),
        ("NetworkAreaParam".to_string(), get_render_lambda::<NetworkAreaParam>()),
        ("NetworkMsgParam".to_string(), get_render_lambda::<NetworkMsgParam>()),
        ("NetworkParam".to_string(), get_render_lambda::<NetworkParam>()),
        ("NewMenuColorTableParam".to_string(), get_render_lambda::<NewMenuColorTableParam>()),
        ("NpcAiActionParam".to_string(), get_render_lambda::<NpcAiActionParam>()),
        ("NpcParam".to_string(), get_render_lambda::<NpcParam>()),
        ("NpcThinkParam".to_string(), get_render_lambda::<NpcThinkParam>()),
        ("ObjActParam".to_string(), get_render_lambda::<ObjActParam>()),
        ("ObjectMaterialSfxParam".to_string(), get_render_lambda::<ObjectMaterialSfxParam>()),
        ("ObjectParam".to_string(), get_render_lambda::<ObjectParam>()),
        ("PhantomParam".to_string(), get_render_lambda::<PhantomParam>()),
        ("PlayRegionParam".to_string(), get_render_lambda::<PlayRegionParam>()),
        ("ProtectorGenParam".to_string(), get_render_lambda::<ProtectorGenParam>()),
        ("RagdollParam".to_string(), get_render_lambda::<RagdollParam>()),
        ("ReinforceParamProtector".to_string(), get_render_lambda::<ReinforceParamProtector>()),
        ("ReinforceParamWeapon".to_string(), get_render_lambda::<ReinforceParamWeapon>()),
        ("RoleParam".to_string(), get_render_lambda::<RoleParam>()),
        ("SeMaterialConvertParam".to_string(), get_render_lambda::<SeMaterialConvertParam>()),
        ("ShopLineupParam".to_string(), get_render_lambda::<ShopLineupParam>()),
        ("SkeletonParam".to_string(), get_render_lambda::<SkeletonParam>()),
        ("SpEffectParam".to_string(), get_render_lambda::<SpEffectParam>()),
        ("SpEffectVfxParam".to_string(), get_render_lambda::<SpEffectVfxParam>()),
        ("SwordArtsParam".to_string(), get_render_lambda::<SwordArtsParam>()),
        ("TalkParam".to_string(), get_render_lambda::<TalkParam>()),
        ("ThrowDirectionSfxParam".to_string(), get_render_lambda::<ThrowDirectionSfxParam>()),
        ("ThrowParam".to_string(), get_render_lambda::<ThrowParam>()),
        ("ToughnessParam".to_string(), get_render_lambda::<ToughnessParam>()),
        ("UpperArmParam".to_string(), get_render_lambda::<UpperArmParam>()),
        ("WeaponGenParam".to_string(), get_render_lambda::<WeaponGenParam>()),
        ("WepAbsorpPosParam".to_string(), get_render_lambda::<WepAbsorpPosParam>()),
        ("WetAspectParam".to_string(), get_render_lambda::<WetAspectParam>()),
        ("WhiteSignCoolTimeParam".to_string(), get_render_lambda::<WhiteSignCoolTimeParam>()),
        ("Wind".to_string(), get_render_lambda::<Wind>()),
    ].into_iter().collect();
});
...
impl RenderableParam for AtkParam_Npc {
    pub fn render_imgui(&mut self, ui: &imgui::Ui) { 
...
impl RenderableParam for Bullet {
    pub fn render_imgui(&mut self, ui: &imgui::Ui) { 
        ...
        if ui.input_float("bulletEmitter_ShootInterval0", &mut i).build() {
        ...
        if ui.input_float("bulletEmitter_ShootInterval1", &mut i).build() {
...
impl RenderableParam for NpcParam {
    pub fn render_imgui(&mut self, ui: &imgui::Ui) { 
        ...
        if ui.input_float("SuperArmorRecoverCorrection", &mut i).build() {
            self.super_armor_recover_correction = i;
        }

        let mut i: f32 = self.super_armor_brake_knockback_dist;
        if ui.input_float("SuperArmorBrakeKnockbackDist", &mut i).build() {
...
impl RenderableParam for NpcThinkParam {
    pub fn render_imgui(&mut self, ui: &imgui::Ui) { 
        ...
        if ui.input_int("callHelp_CallValidMinDistTarget", &mut i).build() {
...
impl Params {
    #[allow(unused)]
    pub unsafe fn get_action_button_param(&self) -> Option<impl Iterator<Item = Param<ActionButtonParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_attack_element_correct_param(&self) -> Option<impl Iterator<Item = Param<AttackElementCorrectParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_behavior_param_pc(&self) -> Option<impl Iterator<Item = Param<BehaviorParam_PC>>> {
        self.iter_param::<BehaviorParam_PC>("BehaviorParam_PC")
    }

    #[allow(unused)]
    pub unsafe fn get_bonfire_warp_param(&self) -> Option<impl Iterator<Item = Param<BonfireWarpParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_bullet_create_limit_param(&self) -> Option<impl Iterator<Item = Param<BulletCreateLimitParam>>> {
        self.iter_param::<BulletCreateLimitParam>("BulletCreateLimitParam")
    }

    #[allow(unused)]
    pub unsafe fn get_calc_correct_graph(&self) -> Option<impl Iterator<Item = Param<CalcCorrectGraph>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_character_load_param(&self) -> Option<impl Iterator<Item = Param<CharacterLoadParam>>> {
        self.iter_param::<CharacterLoadParam>("CharacterLoadParam")
    }

    #[allow(unused)]
    pub unsafe fn get_chara_init_param(&self) -> Option<impl Iterator<Item = Param<CharaInitParam>>> {
        self.iter_param::<CharaInitParam>("CharaInitParam")
    }

    #[allow(unused)]
    pub unsafe fn get_char_make_menu_list_item_param(&self) -> Option<impl Iterator<Item = Param<CharMakeMenuListItemParam>>> {
        self.iter_param::<CharMakeMenuListItemParam>("CharMakeMenuListItemParam")
    }

    #[allow(unused)]
    pub unsafe fn get_char_make_menu_top_param(&self) -> Option<impl Iterator<Item = Param<CharMakeMenuTopParam>>> {
        self.iter_param::<CharMakeMenuTopParam>("CharMakeMenuTopParam")
    }

    #[allow(unused)]
    pub unsafe fn get_clear_count_correct_param(&self) -> Option<impl Iterator<Item = Param<ClearCountCorrectParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_cult_setting_param(&self) -> Option<impl Iterator<Item = Param<CultSettingParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_direction_camera_param(&self) -> Option<impl Iterator<Item = Param<DirectionCameraParam>>> {
        self.iter_param::<DirectionCameraParam>("DirectionCameraParam")
    }

    #[allow(unused)]
    pub unsafe fn get_equip_mtrl_set_param(&self) -> Option<impl Iterator<Item = Param<EquipMtrlSetParam>>> {
        self.iter_param::<EquipMtrlSetParam>("EquipMtrlSetParam")
    }

    #[allow(unused)]
    pub unsafe fn get_equip_param_accessory(&self) -> Option<impl Iterator<Item = Param<EquipParamAccessory>>> {
        self.iter_param::<EquipParamAccessory>("EquipParamAccessory")
    }

    #[allow(unused)]
    pub unsafe fn get_equip_param_goods(&self) -> Option<impl Iterator<Item = Param<EquipParamGoods>>> {
        self.iter_param::<EquipParamGoods>("EquipParamGoods")
    }

    #[allow(unused)]
    pub unsafe fn get_equip_param_protector(&self) -> Option<impl Iterator<Item = Param<EquipParamProtector>>> {
        self.iter_param::<EquipParamProtector>("EquipParamProtector")
    }

    #[allow(unused)]
    pub unsafe fn get_equip_param_weapon(&self) -> Option<impl Iterator<Item = Param<EquipParamWeapon>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_face_range_param(&self) -> Option<impl Iterator<Item = Param<FaceRangeParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_game_progress_param(&self) -> Option<impl Iterator<Item = Param<GameProgressParam>>> {
        self.iter_param::<GameProgressParam>("GameProgressParam")
    }

    #[allow(unused)]
    pub unsafe fn get_gem_category_param(&self) -> Option<impl Iterator<Item = Param<GemCategoryParam>>> {
        self.iter_param::<GemCategoryParam>("GemCategoryParam")
    }

    #[allow(unused)]
    pub unsafe fn get_gem_drop_doping_param(&self) -> Option<impl Iterator<Item = Param<GemDropDopingParam>>> {
        self.iter_param::<GemDropDopingParam>("GemDropDopingParam")
    }

    #[allow(unused)]
    pub unsafe fn get_gem_drop_modify_param(&self) -> Option<impl Iterator<Item = Param<GemDropModifyParam>>> {
        self.iter_param::<GemDropModifyParam>("GemDropModifyParam")
    }

    #[allow(unused)]
    pub unsafe fn get_gemeffect_param(&self) -> Option<impl Iterator<Item = Param<GemeffectParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_hit_effect_se_param(&self) -> Option<impl Iterator<Item = Param<HitEffectSeParam>>> {
        self.iter_param::<HitEffectSeParam>("HitEffectSeParam")
    }

    #[allow(unused)]
    pub unsafe fn get_hit_effect_sfx_concept_param(&self) -> Option<impl Iterator<Item = Param<HitEffectSfxConceptParam>>> {
        self.iter_param::<HitEffectSfxConceptParam>("HitEffectSfxConceptParam")
    }

    #[allow(unused)]
    pub unsafe fn get_hit_effect_sfx_param(&self) -> Option<impl Iterator<Item = Param<HitEffectSfxParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_h_pestus_flask_recovery_param(&self) -> Option<impl Iterator<Item = Param<HPEstusFlaskRecoveryParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_knock_back_param(&self) -> Option<impl Iterator<Item = Param<KnockBackParam>>> {
        self.iter_param::<KnockBackParam>("KnockBackParam")
    }

    #[allow(unused)]
    pub unsafe fn get_knowledge_load_screen_item_param(&self) -> Option<impl Iterator<Item = Param<KnowledgeLoadScreenItemParam>>> {
        self.iter_param::<KnowledgeLoadScreenItemParam>("KnowledgeLoadScreenItemParam")
    }

    #[allow(unused)]
    pub unsafe fn get_load_balancer_draw_dist_scale_param(&self) -> Option<impl Iterator<Item = Param<LoadBalancerDrawDistScaleParam>>> {
        self.iter_param::<LoadBalancerDrawDistScaleParam>("LoadBalancerDrawDistScaleParam")
    }

    #[allow(unused)]
    pub unsafe fn get_load_balancer_param(&self) -> Option<impl Iterator<Item = Param<LoadBalancerParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_map_mimicry_establishment_param(&self) -> Option<impl Iterator<Item = Param<MapMimicryEstablishmentParam>>> {
        self.iter_param::<MapMimicryEstablishmentParam>("MapMimicryEstablishmentParam")
    }

    #[allow(unused)]
    pub unsafe fn get_menu_offscr_rend_param(&self) -> Option<impl Iterator<Item = Param<MenuOffscrRendParam>>> {
        self.iter_param::<MenuOffscrRendParam>("MenuOffscrRendParam")
    }

    #[allow(unused)]
    pub unsafe fn get_menu_property_layout_param(&self) -> Option<impl Iterator<Item = Param<MenuPropertyLayoutParam>>> {
        self.iter_param::<MenuPropertyLayoutParam>("MenuPropertyLayoutParam")
    }

    #[allow(unused)]
    pub unsafe fn get_menu_property_spec_param(&self) -> Option<impl Iterator<Item = Param<MenuPropertySpecParam>>> {
        self.iter_param::<MenuPropertySpecParam>("MenuPropertySpecParam")
    }

    #[allow(unused)]
    pub unsafe fn get_menu_value_table_param(&self) -> Option<impl Iterator<Item = Param<MenuValueTableParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_m_pestus_flask_recovery_param(&self) -> Option<impl Iterator<Item = Param<MPEstusFlaskRecoveryParam>>> {
        self.iter_param::<MPEstusFlaskRecoveryParam>("MPEstusFlaskRecoveryParam")
    }

    #[allow(unused)]
    pub unsafe fn get_multi_hpestus_flask_bonus_param(&self) -> Option<impl Iterator<Item = Param<MultiHPEstusFlaskBonusParam>>> {
        self.iter_param::<MultiHPEstusFlaskBonusParam>("MultiHPEstusFlaskBonusParam")
    }

    #[allow(unused)]
    pub unsafe fn get_multi_mpestus_flask_bonus_param(&self) -> Option<impl Iterator<Item = Param<MultiMPEstusFlaskBonusParam>>> {
        self.iter_param::<MultiMPEstusFlaskBonusParam>("MultiMPEstusFlaskBonusParam")
    }

    #[allow(unused)]
    pub unsafe fn get_multi_play_correction_param(&self) -> Option<impl Iterator<Item = Param<MultiPlayCorrectionParam>>> {
        self.iter_param::<MultiPlayCorrectionParam>("MultiPlayCorrectionParam")
    }

    #[allow(unused)]
    pub unsafe fn get_multi_soul_bonus_rate_param(&self) -> Option<impl Iterator<Item = Param<MultiSoulBonusRateParam>>> {
        self.iter_param::<MultiSoulBonusRateParam>("MultiSoulBonusRateParam")
    }

    #[allow(unused)]
    pub unsafe fn get_network_area_param(&self) -> Option<impl Iterator<Item = Param<NetworkAreaParam>>> {
        self.iter_param::<NetworkAreaParam>("NetworkAreaParam")
    }

    #[allow(unused)]
    pub unsafe fn get_network_msg_param(&self) -> Option<impl Iterator<Item = Param<NetworkMsgParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_new_menu_color_table_param(&self) -> Option<impl Iterator<Item = Param<NewMenuColorTableParam>>> {
        self.iter_param::<NewMenuColorTableParam>("NewMenuColorTableParam")
    }

    #[allow(unused)]
    pub unsafe fn get_npc_ai_action_param(&self) -> Option<impl Iterator<Item = Param<NpcAiActionParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_object_material_sfx_param(&self) -> Option<impl Iterator<Item = Param<ObjectMaterialSfxParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_play_region_param(&self) -> Option<impl Iterator<Item = Param<PlayRegionParam>>> {
        self.iter_param::<PlayRegionParam>("PlayRegionParam")
    }

    #[allow(unused)]
    pub unsafe fn get_protector_gen_param(&self) -> Option<impl Iterator<Item = Param<ProtectorGenParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_reinforce_param_protector(&self) -> Option<impl Iterator<Item = Param<ReinforceParamProtector>>> {
        self.iter_param::<ReinforceParamProtector>("ReinforceParamProtector")
    }

    #[allow(unused)]
    pub unsafe fn get_reinforce_param_weapon(&self) -> Option<impl Iterator<Item = Param<ReinforceParamWeapon>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_se_material_convert_param(&self) -> Option<impl Iterator<Item = Param<SeMaterialConvertParam>>> {
        self.iter_param::<SeMaterialConvertParam>("SeMaterialConvertParam")
    }

    #[allow(unused)]
    pub unsafe fn get_shop_lineup_param(&self) -> Option<impl Iterator<Item = Param<ShopLineupParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_sp_effect_vfx_param(&self) -> Option<impl Iterator<Item = Param<SpEffectVfxParam>>> {
        self.iter_param::<SpEffectVfxParam>("SpEffectVfxParam")
    }

    #[allow(unused)]
    pub unsafe fn get_sword_arts_param(&self) -> Option<impl Iterator<Item = Param<SwordArtsParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_throw_direction_sfx_param(&self) -> Option<impl Iterator<Item = Param<ThrowDirectionSfxParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_toughness_param(&self) -> Option<impl Iterator<Item = Param<ToughnessParam>>> {
    ...
    #[allow(unused)]
    pub unsafe fn get_weapon_gen_param(&self) -> Option<impl Iterator<Item = Param<WeaponGenParam>>> {
        self.iter_param::<WeaponGenParam>("WeaponGenParam")
    }

    #[allow(unused)]
    pub unsafe fn get_wep_absorp_pos_param(&self) -> Option<impl Iterator<Item = Param<WepAbsorpPosParam>>> {
        self.iter_param::<WepAbsorpPosParam>("WepAbsorpPosParam")
    }

    #[allow(unused)]
    pub unsafe fn get_wet_aspect_param(&self) -> Option<impl Iterator<Item = Param<WetAspectParam>>> {
        self.iter_param::<WetAspectParam>("WetAspectParam")
    }

    #[allow(unused)]
    pub unsafe fn get_white_sign_cool_time_param(&self) -> Option<impl Iterator<Item = Param<WhiteSignCoolTimeParam>>> {
